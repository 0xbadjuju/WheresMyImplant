...
namespace WheresMyImplant
{
    class Winternl
    {
        ...
        internal struct PEB64
        {
            ...
            public BYTE BeingDebugged;
            public BYTE _SYSTEM_DEPENDENT_01;
            public QWORD dummyalign;
            public QWORD Mutant;
            public QWORD ImageBaseAddress;
            public QWORD Ldr;
            public QWORD ProcessParameters;
            public QWORD SubSystemData;
            public QWORD ProcessHeap;
            public QWORD FastPebLock;
            public QWORD _SYSTEM_DEPENDENT_02;
            public QWORD _SYSTEM_DEPENDENT_03;
            public QWORD _SYSTEM_DEPENDENT_04;
            public QWORD KernelCallbackTable;
            public QWORD UserSharedInfoPtr;
            public DWORD SystemReserved;
            public DWORD _SYSTEM_DEPENDENT_05;
            public QWORD _SYSTEM_DEPENDENT_06;
            public QWORD TlsExpansionCounter;
            public QWORD TlsBitmap;
            [MarshalAs(UnmanagedType.U4, SizeConst=2)]
            public DWORD TlsBitmapBits;
            public QWORD ReadOnlySharedMemoryBase;
            public QWORD _SYSTEM_DEPENDENT_07;
            public QWORD ReadOnlyStaticServerData;
            public QWORD AnsiCodePageData;
            public QWORD OemCodePageData;
            public QWORD UnicodeCaseTableData;
            public DWORD NumberOfProcessors;
            public DWORD NtGlobalFlag;
        ...
        */
        ...
        [StructLayout(LayoutKind.Sequential, Pack=1)]
        internal struct _PEB64 {
            [MarshalAs(UnmanagedType.LPArray, SizeConst = 2)]
            public BYTE Reserved1;
            public BYTE BeingDebugged;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 21)]
            public BYTE Reserved2;
            public IntPtr LoaderData; /*_PEB_LDR_DATA*/
            public IntPtr ProcessParameters; /*_RTL_USER_PROCESS_PARAMETERS*/
            [MarshalAs(UnmanagedType.LPArray, SizeConst = 520)]
            public BYTE Reserved3;
            public IntPtr PostProcessInitRoutine; /*_PS_POST_PROCESS_INIT_ROUTINE*/
            [MarshalAs(UnmanagedType.LPArray, SizeConst = 136)]
            public BYTE Reserved4;
            public ULONG SessionId;
        }

        [StructLayout(LayoutKind.Sequential, Pack=1)]
        internal struct _PEB_LDR_DATA {
        ...
        [StructLayout(LayoutKind.Sequential, Pack=1)]
        internal struct _LIST_ENTRY {
            IntPtr Flink;
            IntPtr Blink;
        }

        [StructLayout(LayoutKind.Sequential, Pack=1)]
        internal struct _LDR_DATA_TABLE_ENTRY {
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
            PVOID Reserved1;
        ...
        [StructLayout(LayoutKind.Sequential, Pack=1)]
        internal struct _RTL_USER_PROCESS_PARAMETERS {
